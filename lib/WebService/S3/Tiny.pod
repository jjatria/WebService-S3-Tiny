...
with the difference that they do not take a C<content> argument, and take a
final optional argument to indicate the lifetime of the URL in seconds.
This value cannot be longer than 604800 (= one week).
...
=head2 signed_url
 ...
 $s3->signed_url($method, $bucket, $object, $content, \%headers, \%parameters, $expires);
